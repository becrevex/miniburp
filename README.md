MiniBurp is a minimized, modular Python-based intercepting proxy clone of Burp Suite, built on top of the excellent open-source mitmproxy library. 
It provides just enough core functionality to effectively test the OWASP Top 10 while remaining lightweight and extensible.

Key Features (OWASP Top 10 Coverage)Full Proxy + Intercept (like Burp Proxy): HTTP/HTTPS MITM proxy. Intercept, view, edit, forward, or drop requests/responses.
